...
module.exports = {
    execute: function execute(message) {
        ...
        const embed = new discord.RichEmbed()
            ...
            'create their own custom bots. The Ava bot itself however is completely open to public use.')
            .addField('Framework', 'Language: *Javascript (node.js)*' +
            '\nDiscord API Library: *discord.js*')
            .addField('Version', packageMod.version)
            .addField('Author', 'James L#0633');
